let replay1_data;_360‍.x([["searchName",()=>searchName],["renderPlayerSearch",()=>renderPlayerSearch],["renderTeamSearch",()=>renderTeamSearch]]);_360‍.w("./data/replay1_data.js",[["default",["replay1_data"],function(v){replay1_data=v}]]);
...
let foundNames = [];
    ...
    return searchNameAns.map(c => c.name);
       ...
       const renderPlayerSearch = function() {
...
let enteredTeam;
       ...
       const renderTeamSearch = function() {
    return `<div class="box" style="display: flex">
    <span style="display: inline-flex; flex-grow: 1; align-items: center;">
