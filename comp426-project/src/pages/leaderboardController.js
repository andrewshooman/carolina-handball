...
export function renderTeamTableEntry(team) { 
    return `<tr>
...
export function renderPlayerTableEntry(player) { 
    return `<tr>
    <th>${tmpGlobalincrement}</th>
    <td>${player.name}</td>
    <td>${player.team}</td>
...
export function renderSelectorBox() {
...
export function handleTeamsButtonClick() {
...
export function handlePlayersButtonClick() {
    tmpGlobalincrement = 1;
    $("#table").empty();
...
export function getGoalParticipation(player) { 
...
// leaderboard stuff
export function loadTeamsIntoLeaderboard() {
    $("#roott").append(renderSelectorBox());
